 ...
 * </p>
 * <ul>
 *   <li>{@link com.br.terra.dcl.dCL.DCLSensor#getManagingSubsystem <em>Managing Subsystem</em>}</li>
 * </ul>
 *
 * @see com.br.terra.dcl.dCL.DCLPackage#getDCLSensor()
 * @model
 * @generated
 */
public interface DCLSensor extends DCLStructureElement
{
  /**
   ...
   * @see com.br.terra.dcl.dCL.DCLPackage#getDCLSensor_ManagingSubsystem()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link com.br.terra.dcl.dCL.DCLSensor#getManagingSubsystem <em>Managing Subsystem</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
