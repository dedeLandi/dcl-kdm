 ...
 * </p>
 * <ul>
 *   <li>{@link com.br.terra.dcl.dCL.DCLExecutor#getManagingSubsystem <em>Managing Subsystem</em>}</li>
 * </ul>
 *
 * @see com.br.terra.dcl.dCL.DCLPackage#getDCLExecutor()
 * @model
 * @generated
 */
public interface DCLExecutor extends DCLStructureElement
{
  /**
   ...
   * @see com.br.terra.dcl.dCL.DCLPackage#getDCLExecutor_ManagingSubsystem()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link com.br.terra.dcl.dCL.DCLExecutor#getManagingSubsystem <em>Managing Subsystem</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
