 ...
 * </p>
 * <ul>
 *   <li>{@link com.br.terra.dcl.dCL.impl.DCLAnalyzerImpl#getManagingSubsystem <em>Managing Subsystem</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DCLAnalyzerImpl extends DCLStructureElementImpl implements DCLAnalyzer
{
  /**
  ...
  {
    return DCLPackage.Literals.DCL_ANALYZER;
  }
    ...
    if (managingSubsystem != null && managingSubsystem.eIsProxy())
    {
      ...
      if (managingSubsystem != oldManagingSubsystem)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, DCLPackage.DCL_ANALYZER__MANAGING_SUBSYSTEM, oldManagingSubsystem, managingSubsystem));
      }
    }
  ...
  public void setManagingSubsystem(DCLManagingSubsystem newManagingSubsystem)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DCLPackage.DCL_ANALYZER__MANAGING_SUBSYSTEM, oldManagingSubsystem, managingSubsystem));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DCLPackage.DCL_ANALYZER__MANAGING_SUBSYSTEM:
