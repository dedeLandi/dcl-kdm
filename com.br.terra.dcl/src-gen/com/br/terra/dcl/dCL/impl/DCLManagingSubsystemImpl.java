...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Managing Subsystem</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.br.terra.dcl.dCL.impl.DCLManagingSubsystemImpl#getManagingSubsystem <em>Managing Subsystem</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DCLManagingSubsystemImpl extends DCLStructureElementImpl implements DCLManagingSubsystem
{
  /**
   ...
   * @generated
   */
  protected DCLManagingSubsystemImpl()
  {
    super();
  }
  ...
  {
    return DCLPackage.Literals.DCL_MANAGING_SUBSYSTEM;
  }
    ...
    if (managingSubsystem != null && managingSubsystem.eIsProxy())
    {
      ...
      if (managingSubsystem != oldManagingSubsystem)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, DCLPackage.DCL_MANAGING_SUBSYSTEM__MANAGING_SUBSYSTEM, oldManagingSubsystem, managingSubsystem));
      }
    }
  ...
  public void setManagingSubsystem(DCLManagingSubsystem newManagingSubsystem)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DCLPackage.DCL_MANAGING_SUBSYSTEM__MANAGING_SUBSYSTEM, oldManagingSubsystem, managingSubsystem));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DCLPackage.DCL_MANAGING_SUBSYSTEM__MANAGING_SUBSYSTEM:
