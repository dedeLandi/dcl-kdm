 ...
 * </p>
 * <ul>
 *   <li>{@link com.br.terra.dcl.dCL.DCLMonitor#getManagingSubsystem <em>Managing Subsystem</em>}</li>
 * </ul>
 *
 * @see com.br.terra.dcl.dCL.DCLPackage#getDCLMonitor()
 * @model
 * @generated
 */
public interface DCLMonitor extends DCLStructureElement
{
  /**
   ...
   * @see com.br.terra.dcl.dCL.DCLPackage#getDCLMonitor_ManagingSubsystem()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link com.br.terra.dcl.dCL.DCLMonitor#getManagingSubsystem <em>Managing Subsystem</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
